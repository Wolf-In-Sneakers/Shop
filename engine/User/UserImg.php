    ...
    public function create_bond_user_img(int $id_user, int $id_image): array
    {
        ...
        if ($answer->fetch_assoc())
            ...
            if ($this->mysqli->query($sql_query))
                ...
                throw new Exception("Не удаллось создать связь между изображением и пользователем!");
        }
        ...
        if ($answer->fetch_assoc()) {
            ...
            if ($answer->fetch_assoc()) {
                ...
                if ($this->mysqli->query($sql_query))
                    ...
                    throw new Exception("Не удалось удалить связь между изображением и пользователем из базы данных!");
                }
            } else {
            ...
            throw new Exception("Неверно указан пользователь или изображение!");
