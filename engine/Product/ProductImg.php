...
class ProductImg
{
    ...
    private function create_thumbnail(string $path, string $save, int $width, int $height)
    {
    ...
    public function create_bond_product_img(int $id_product, int $id_image): array
    {
        ...
        if ($answer->fetch_assoc())
            ...
            if ($this->mysqli->query($sql_query))
                ...
                $message["error"] = "Не удаллось создать связь между изображением и товаром!";
        }
        ...
        if ($answer->fetch_assoc()) {
            ...
            if ($answer->fetch_assoc()) {
                ...
                if ($this->mysqli->query($sql_query))
                    ...
                    $message["error"] = "Не удалось удалить связь между изображением и товаром из базы данных!";
                    return $message;
                }
            } else {
            ...
            $message["error"] = "Неверно указан товар или изображение!";
